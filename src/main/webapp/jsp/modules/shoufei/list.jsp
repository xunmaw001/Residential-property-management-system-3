...
<!--/Pre Loader -->
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="shoufeiUuidNumberSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="收费编号" aria-controls="tableId">
                                        </div>
                                    </div>
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="shoufeiNameSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="收费名称" aria-controls="tableId">
                                        </div>
                                    </div>
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            //收费编号
            var shoufeiUuidNumberSearchInput = $('#shoufeiUuidNumberSearch');
            if( shoufeiUuidNumberSearchInput != null){
                if (shoufeiUuidNumberSearchInput.val() != null && shoufeiUuidNumberSearchInput.val() != '') {
                    searchForm.shoufeiUuidNumber = $('#shoufeiUuidNumberSearch').val();
                }
            }
        ...
        function getDataList() {
            http("shoufei/page", "GET", {
                ...
                shoufeiDelete: 1,
                //本表的
                shoufeiUuidNumber: searchForm.shoufeiUuidNumber,
        ...
        function setDataRow(item, number) {
            ...
            //收费编号
            var shoufeiUuidNumberCell = document.createElement('td');
            shoufeiUuidNumberCell.innerHTML = item.shoufeiUuidNumber;
            row.appendChild(shoufeiUuidNumberCell);
            ...
            //收费金额
            var shoufeiJineCell = document.createElement('td');
            shoufeiJineCell.innerHTML = item.shoufeiJine;
            row.appendChild(shoufeiJineCell);
