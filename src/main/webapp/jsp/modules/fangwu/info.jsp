                                ...
                                <input id="yonghuId" name="yonghuId" v-model="ruleForm.yonghuId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="fangwuUuidNumber" name="fangwuUuidNumber" class="form-control"
                                               v-model="ruleForm.fangwuUuidNumber" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="fangwuLoudong" name="fangwuLoudong" class="form-control"
                                               v-model="ruleForm.fangwuLoudong" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="fangwuDanyuan" name="fangwuDanyuan" class="form-control"
                                               v-model="ruleForm.fangwuDanyuan" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="fangwuFanghao" name="fangwuFanghao" class="form-control"
                                               v-model="ruleForm.fangwuFanghao" readonly>
                                    </div>
