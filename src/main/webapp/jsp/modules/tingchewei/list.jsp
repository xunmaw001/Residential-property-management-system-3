...
<!--/Pre Loader -->
                ...
                <div class="row breadcrumb-bar">
                    ...
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">停车位列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="tingcheweiUuidNumberSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="停车位编号" aria-controls="tableId">
                                        </div>
                                    </div>
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        停车位位置
                                        <div class="layui-input-inline">
                                            <input type="text" id="tingcheweiAddressSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="停车位位置" aria-controls="tableId">
                                        </div>
                                    </div>
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            //停车位编号
            var tingcheweiUuidNumberSearchInput = $('#tingcheweiUuidNumberSearch');
            if( tingcheweiUuidNumberSearchInput != null){
                if (tingcheweiUuidNumberSearchInput.val() != null && tingcheweiUuidNumberSearchInput.val() != '') {
                    searchForm.tingcheweiUuidNumber = $('#tingcheweiUuidNumberSearch').val();
                }
            }
     
            //停车位位置
            var tingcheweiAddressSearchInput = $('#tingcheweiAddressSearch');
            if( tingcheweiAddressSearchInput != null){
                if (tingcheweiAddressSearchInput.val() != null && tingcheweiAddressSearchInput.val() != '') {
                    searchForm.tingcheweiAddress = $('#tingcheweiAddressSearch').val();
                }
            }
                        getDataList();
        }
        ...
        function getDataList() {
            http("tingchewei/page", "GET", {
                ...
                tingcheweiDelete: 1,
                //本表的
                tingcheweiUuidNumber: searchForm.tingcheweiUuidNumber,
                tingcheweiAddress: searchForm.tingcheweiAddress,
            //级联表的
        ...
        function setDataRow(item, number) {
            ...
            //停车位编号
            var tingcheweiUuidNumberCell = document.createElement('td');
            tingcheweiUuidNumberCell.innerHTML = item.tingcheweiUuidNumber;
            row.appendChild(tingcheweiUuidNumberCell);


            //停车位位置
            var tingcheweiAddressCell = document.createElement('td');
            tingcheweiAddressCell.innerHTML = item.tingcheweiAddress;
            row.appendChild(tingcheweiAddressCell);
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addtingchewei", "addtingchewei");
            window.location.href = "add-or-update.jsp"
        }
